...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-J0u7bVIl.mjs");
...
var manifest = {
	"22a4967de31c4d047054f1c64511fc76908955d0e09f584e158e44d22b009347": {
		functionName: "suggestQueries_createServerFn_handler",
		importer: () => import("./api-C8zcCW2y.mjs")
	},
	"98cab733c846522b7523096d98c99bfe33700d7a9cf12efdb768a5c68ad01f0b": {
		functionName: "searchProducts_createServerFn_handler",
		importer: () => import("./api-C8zcCW2y.mjs")
	},
	"c45bb8b44c4fb9450ce38443e411efb4e3f3de3bfc00fe49956a04af3c969f2d": {
		functionName: "getStoreStatus_createServerFn_handler",
		importer: () => import("./api-C8zcCW2y.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BJ30Rwp6.mjs").then((n) => n.t),
