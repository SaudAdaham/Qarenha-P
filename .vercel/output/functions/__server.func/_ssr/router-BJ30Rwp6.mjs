...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BJ30Rwp6.js
...
var styles_default = "/assets/styles-B6Ie8Uhm.css";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: "قارنها — ابحث مرة واحدة وقارن قبل أن تشتري" },
			{
				name: "description",
				content: "قارنها محرك بحث ومقارنة للمنتجات عبر متاجر أمازون ونون وإيباي وغيرها. ابحث مرة واحدة، ثم انتقل إلى المتجر الأصلي."
			},
			{
				name: "theme-color",
				content: "#245C4A"
...
var $$splitComponentImporter$2 = () => import("./routes-CmX8kr5r.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./search-CL_TCwX1.mjs");
var Route$1 = createFileRoute("/search")({
	validateSearch: (search) => ({
		q: String(search.q ?? ""),
		sort: search.sort === "price-desc" || search.sort === "store" || search.sort === "price" ? search.sort : "price",
		stores: String(search.stores ?? "")
	}),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./stores-LttUsrs4.mjs");
var Route = createFileRoute("/stores")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
